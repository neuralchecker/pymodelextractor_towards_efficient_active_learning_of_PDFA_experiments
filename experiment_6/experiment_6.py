    ...
    try:
        ...
        for size in sizes:
            ...
            for i in range(n):
                ...
                pdfa = pdfa_generator.pdfa_from_dfa(dfa,distributions= 5, max_shift = 0.0001)           
                pdfas.append(pdfa)
...
def experiment_random_PDFAS():
        ...
        for pdfa in pdfas:
            for i in range(number_of_executions):
                ...
                if i > 0:
                    ...
                    log_probability_error, wer,ndcg, out_of_partition, out_of_tolerance, absolute_error_avg  = compute_stats(pdfa, extracted_model, partitions = partitions, tolerance = tolerance)
    ...
    dfresults.to_csv('./experiment_6/results/results_'+datetime.datetime.now().strftime("%d_%m_%Y_%H_%M_%S")+'.csv') 
